      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            className="fixed top-[104px] left-0 right-0 w-full bg-white border-l border-r border-b border-t border-gray-300 z-50 rounded-b-3xl shadow-lg max-h-[calc(100vh-120px)] overflow-y-auto"
