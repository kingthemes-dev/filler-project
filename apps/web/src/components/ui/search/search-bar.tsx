    ...
    <SearchErrorBoundary>
      <div className={`relative ${className}`} ref={searchRef} style={{ position: 'relative' }}>
        ...
        <input
          ...
          className={`block w-full pl-10 pr-10 py-3 border border-gray-300 leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-black focus:border-transparent text-sm ${
