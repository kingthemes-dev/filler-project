      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-50 via-gray-100 to-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] md:max-h-[80vh] overflow-y-auto"
              ...
              <div className="flex flex-col lg:flex-row h-full relative">
                ...
                <div className="lg:w-1/2 p-4 sm:p-6">
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      {/* Quantity Selector */}
                      <div className="flex items-center border border-gray-200 rounded-lg h-[56px] w-[120px]">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => setQuantity(Math.max(1, quantity - 1))}
                          className="rounded-l-lg rounded-r-none h-full px-2"
                        >
                          <Minus className="w-4 h-4" />
                        </Button>
                        <span className="px-2 py-2 min-w-[32px] text-center h-full flex items-center justify-center">
                          {quantity}
                        </span>
                        <Button
                          variant="ghost"
