    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-auto max-h-[90vh] overflow-y-auto">
              {/* Header */}
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-blue-700">
                        Dane osobowe wypełnisz później przy składaniu zamówienia
                        i zostaną zapisane na stałe.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {!formData.password && (
                      <p className="mt-1 text-xs text-gray-500">
                        Minimum 8 znaków, mała i wielka litera, cyfra, znak
                        specjalny
                      </p>
                    )}
                  </div>
                  ...
                  <div className="relative p-4 border border-purple-200/50 rounded-xl bg-white/80 backdrop-blur-sm">
                    <label className="cursor-pointer group">
                      ...
                      <p className="text-sm text-gray-600 leading-relaxed ml-7">
                        Wyrażam zgodę na otrzymywanie ofert marketingowych i
                        odbieram kod rabatowy 10% na następne zakupy.
                      </p>
                    </label>
                  </div>
                </div>
