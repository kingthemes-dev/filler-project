        ...
        <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.02)_50%,transparent_75%)] bg-[length:20px_20px]"></div>
         ...
         <div className="relative max-w-[95vw] mx-auto px-4 sm:px-6">
           ...
           <div className="lg:hidden mb-8">
             <div className="bg-transparent border-2 border-white/20 rounded-xl px-4 pt-3 pb-3 text-left hover:border-white/40 transition-colors">
               ...
               <div className="grid grid-cols-2 gap-3">
                 <a href="#" className="flex items-center bg-black/20 border border-white/20 rounded-lg px-3 py-3 hover:bg-black/40 transition-colors">
