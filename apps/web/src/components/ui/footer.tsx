      ...
      <div className="relative max-w-[90vw] mx-auto mobile-container">
        ...
        <div className="lg:hidden mb-8 -mt-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-transparent border-2 border-white/20 rounded-xl px-4 pt-3 pb-3 text-left hover:border-white/40 transition-colors h-full flex flex-col justify-start">
              <h4 className="content-subheading text-white font-semibold pb-2 mb-3 border-b border-gray-800 flex items-center gap-2">
                <Building2 className="w-5 h-5 text-white/80" />O firmie
              </h4>
            ...
            <div className="bg-transparent border-2 border-white/20 rounded-xl px-4 pt-3 pb-3 text-left hover:border-white/40 transition-colors h-full flex flex-col justify-start">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                ...
                <button
                  ...
                  className="block hover:text-white transition-colors cursor-pointer text-left text-sm text-gray-300 flex items-center gap-2"
                >
        ...
        <div className="lg:hidden mb-8">
          <div className="bg-transparent border-2 border-white/20 rounded-xl px-4 pt-3 pb-3 text-left">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                href="#"
                className="flex items-center bg-gradient-to-r from-black/20 to-black/30 border border-white/20 rounded-lg px-3 py-3 hover:bg-gradient-to-l hover:from-black/30 hover:to-black/20 hover:border-white/40  transition-all duration-300 cursor-pointer"
              >
        ...
        <div className="hidden lg:grid lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-8 sm:gap-12">
          ...
          <div className="lg:pr-12 lg:ml-4">
            ...
            <h4 className="content-subheading font-semibold mb-6 text-white">
              Kontakt
            </h4>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-start">
                <MapPin className="w-4 h-4 mt-1 mr-2 text-gray-400" />
                <div>
                  <p className="content-text text-gray-300">
                    ul. Partyzantów 8/101, 80-254
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="content-text text-gray-300 font-semibold">
                    w godzinach 8:00 - 18:00
                  </p>
                </div>
              </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <button
                  ...
                  className="content-text text-gray-300 hover:text-white transition-colors flex items-center gap-2"
                >
                  <Cookie className="w-4 h-4" />
                  Zarządzaj cookies
                </button>
        ...
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white hover:bg-white/20 transition-all duration-300 text-sm"
          >
            <Cookie className="w-4 h-4" />
