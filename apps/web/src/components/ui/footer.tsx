         ...
         <div className="relative max-w-[95vw] mx-auto px-4 sm:px-6">
           ...
           <div className="lg:hidden mb-8">
             <div className="bg-transparent border-2 border-white/20 rounded-xl px-4 pt-3 pb-3 text-left">
               ...
               <div className="grid grid-cols-2 gap-3">
                 <a href="#" className="flex items-center bg-black/20 border border-white/20 rounded-lg px-3 py-3 hover:bg-black/40 hover:border-white/40 hover:scale-105 transition-all duration-300 cursor-pointer">
                   <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform duration-300">
