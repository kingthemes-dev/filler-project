    ...
    <section className="relative h-auto min-h-[600px] sm:min-h-[650px] lg:min-h-[700px] mt-[24px] rounded-2xl sm:rounded-3xl overflow-hidden">
      <div className="absolute inset-0 h-full">
        <div className="relative h-full overflow-hidden">
          ...
          {/* Content */}
          <div className="relative z-20 h-full flex flex-col justify-center md:justify-start items-center md:items-start text-center md:text-left px-4 sm:px-6 md:px-8 lg:px-12 pt-12 md:pt-[100px]">
