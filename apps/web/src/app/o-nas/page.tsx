            ...
            >
              ...
              <div className="prose max-w-none">
                <p className="content-text text-gray-700 mb-6 leading-relaxed">
                  Filler.pl to firma, która powstała z pasji do medycyny
                  estetycznej i chęci dostarczania najlepszych produktów na
                  dynamicznie rozwijający się rynek. Naszą misją jest wspieranie
                  profesjonalistów w branży, oferując im szeroki wybór
                  sprawdzonych, wysokiej jakości materiałów i narzędzi, które
                  spełniają najwyższe standardy.
                </p>

                <p className="content-text text-gray-700 mb-6 leading-relaxed">
                  Dokładamy wszelkich starań, aby nasza oferta była zawsze
                  aktualna i odpowiadała na potrzeby rynku, regularnie
                  analizując pojawiające się nowinki oraz trendy. Nasz zespół
                  jest zawsze gotowy, by dostosować asortyment do indywidualnych
                  oczekiwań klientów, a także by wprowadzać innowacje, które
                  pomogą w rozwoju gabinetów i klinik medycyny estetycznej.
                </p>

                <p className="content-text text-gray-700 mb-6 leading-relaxed">
                  Wszystkie produkty dostępne w Filler.pl są w pełni oryginalne
                  i pochodzą od certyfikowanych producentów i dystrybutorów,
                  którzy są uznanymi liderami na rynku medycyny estetycznej.
                  Dzięki bliskiej współpracy z najlepszymi markami, możemy
                  zapewnić Państwu konkurencyjne ceny oraz dostęp do produktów,
                  które wyróżniają się na tle innych.
                </p>

                <p className="content-text text-gray-700 mb-6 leading-relaxed">
                  Naszym celem jest nie tylko sprzedaż, ale także budowanie
                  długoterminowych relacji z naszymi klientami. Zależy nam na
                  stałym doskonaleniu jakości obsługi, dlatego czekamy na Wasze
                  sugestie, które pozwolą nam rozwijać się i jeszcze lepiej
                  odpowiadać na potrzeby rynku.
                </p>

                <p className="content-text text-gray-700 mb-8 leading-relaxed font-medium">
                  Zapraszamy do współpracy i zaufania profesjonalistom z
                  Filler.pl!
                </p>
              </div>
            </motion.div>
