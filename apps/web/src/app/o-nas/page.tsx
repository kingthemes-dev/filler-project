  ...
  return (
    <div className="bg-white">
      <PageContainer>
        ...
        <div className="sticky top-[7rem] z-40 bg-gradient-to-br from-gray-50 via-gray-100 to-white border border-gray-200 rounded-3xl -mt-5 lg:mx-0 px-4 lg:px-8 pt-5 pb-6 sm:pt-6 sm:pb-8 mb-8">
