...
export const metadata: Metadata = {
  ...
  description:
    'Filler to miejsce gdzie znajdziesz profesjonalne produkty medycyny estetycznej. Najlepsze ceny. Sprawdź nas.',
  keywords: [
  ...
  verification: {
    google: (env.NEXT_PUBLIC_GA4_ID || env.NEXT_PUBLIC_GA_ID || '')?.replace(
      'G-',
      ''
    ),
  },
  ...
  return (
    <html lang="pl" data-scroll-behavior="smooth">
      <head>
        ...
        <Script
          ...
          try {
            ...
            if (allowAnalytics) {
              ...
              // NOTE: If GTM is used, GA4 should be configured in GTM, not loaded directly
              ${
              ...
              // Load GA4 directly (only if GTM is NOT configured)
              // If GTM_ID is set, GA4 should be configured in GTM instead
              ${
                env.NEXT_PUBLIC_GA4_ID && !env.NEXT_PUBLIC_GTM_ID
                  ? `
        ...
        <link
          rel="preconnect"
          href={env.NEXT_PUBLIC_WORDPRESS_URL}
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(
              generateOrganizationStructuredData(DEFAULT_ORGANIZATION)
            ),
          }}
        />
      ...
      >
        ...
        <RecaptchaProvider>
          <Header />
          <DeferClientUI>{children}</DeferClientUI>
        </RecaptchaProvider>

        {/* Prefetch shop data in background */}
        <ShopDataPrefetcher immediate={true} delay={1000} onlyIfEmpty={true} />
