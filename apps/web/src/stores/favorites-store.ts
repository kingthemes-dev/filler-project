...
export const useFavoritesIsModalOpen = () =>
  useFavoritesStore(state => state.isModalOpen);
export const useFavoritesIsLoading = () =>
  useFavoritesStore(state => state.isLoading);
export const useFavoritesLastSyncTime = () =>
  useFavoritesStore(state => state.lastSyncTime);
...
export const useFavoritesActions = () => {
  ...
  const openFavoritesModal = useFavoritesStore(
    state => state.openFavoritesModal
  );
  const closeFavoritesModal = useFavoritesStore(
    state => state.closeFavoritesModal
  );
