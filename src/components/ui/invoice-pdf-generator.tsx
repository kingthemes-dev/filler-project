...
export const generateInvoicePDF = (invoice: Invoice, orderData?: any) => {
  ...
  yPosition += 10;
  doc.text(`Data: ${new Date(invoice.date).toLocaleDateString('pl-PL')}`, 20, yPosition);
  ...
  yPosition += 5;
  doc.text('Wszystkie produkty są oryginalne i pochodzą z autoryzowanych źródeł.', 20, yPosition);
...
export default function InvoicePDFGenerator({ invoice, orderData }: InvoicePDFGeneratorProps) {
